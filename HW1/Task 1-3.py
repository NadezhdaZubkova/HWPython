...
sum_left_digit= (ticket_num//1000)//100 +(ticket_num//1000)%10 +((ticket_num//1000)//10)%10
sum_right_digit =(ticket_num%1000)//100 +(ticket_num%1000)%10 +((ticket_num%1000)//10)%10
print('YES' if sum_left_digit==sum_right_digit else 'NO')