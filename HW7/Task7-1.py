...
print(True if rhythm('пара-ра-рам рам-пам-папам па-ра-па-дам') else False)
print(True if rhythm('пара-ра-рам рам-пум-пупам па-ре-по-дам') else False)
print(True if rhythm('пара-ра-рам рам-пуум-пупам па-ре-по-дам') else False)
print(True if rhythm('Трам-пара-папам-парам-па-пам-пам-па Пум-пурум-пу-пурум-трам-пам-па') else False)
print(True if rhythm('Пам-парам-пурум Пум-пурум-карам') else False)